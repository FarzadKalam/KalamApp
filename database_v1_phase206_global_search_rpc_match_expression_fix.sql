-- Repair the phase205 global-search RPC dynamic SQL match expression.
-- The generated lateral query must contain a scalar subquery, not a bare aggregate followed by FROM.
