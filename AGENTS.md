...
هر زمان یک ویژگی مهم و جدید به پروژه اضافه شد، همان قابلیت را با متن قابل فهم برای کاربر عمومی در صفحه عمومی «تازه‌ها» هم ثبت کن؛ رفع خطاها، بهینه‌سازی‌های داخلی و تغییرات صرفاً فنی را فقط وقتی اضافه کن که اثر قابل مشاهده و مهمی برای کاربر دارند.
