...
const SummaryCard: React.FC<SummaryCardProps> = ({ type, data, onRefresh, refreshing = false }) => {
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8 text-center w-full md:w-auto">
          <div className="w-full md:w-auto">
            ...
            <div className="text-2xl font-black font-mono">
              {data.total.toLocaleString()} <span className="text-sm font-normal opacity-80">{currencyLabel}</span>
            </div>
          </div>
          ...
          <>
            ...
            <div className="w-full md:w-auto">
              ...
              <div className="text-2xl font-black font-mono text-green-100">
                {data.received.toLocaleString()} <span className="text-sm font-normal opacity-80">{currencyLabel}</span>
              </div>
            </div>
          </>
          )}
          ...
          <>
            ...
            <div className="w-full md:w-auto">
              ...
              <div className="text-2xl font-black font-mono text-orange-100">
                {data.remaining.toLocaleString()} <span className="text-sm font-normal opacity-80">{currencyLabel}</span>
              </div>
            </div>
          </>
          )}
