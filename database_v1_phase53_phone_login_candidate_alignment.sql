-- =====================================================
-- KalamApp - Phase 53 Phone Login Candidate Alignment
-- Date: 2026-03-28
-- Type: Additive / repair migration
-- Goal: only mark phone login as ready when the phone identity belongs to the same auth/profile user
-- =====================================================
