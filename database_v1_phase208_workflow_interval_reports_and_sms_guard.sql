-- KalamApp - Phase 208 workflow interval reports and SMS guard
-- Shows server-side scheduled workflow runs in automation reports.
...
where l.run_type in ('event', 'scheduled', 'process_automation');
