-- KalamApp - Phase 210: Automation reports view compatibility
-- Purpose: expose every workflow/process automation execution safely and keep
-- the system-managed list columns compatible with the report view.
