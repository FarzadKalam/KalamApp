...
const fieldsArray: any[] = [
  ...
  { key: 'address', labels: { fa: 'آدرس کامل', en: 'Address' }, type: FieldType.LONG_TEXT, location: FieldLocation.BLOCK, order: 49, nature: FieldNature.STANDARD, isTableColumn: false },
