...
export const customerModule: ModuleDefinition = {
  ...
  fields: [
    ...
    { key: 'total_spend', labels: { fa: 'جمع بدهکار مشتری', en: 'Customer Debit Total' }, type: FieldType.PRICE, blockId: 'financial_stats', readonly: true },
    { key: 'total_paid_amount', labels: { fa: 'جمع بستانکار مشتری', en: 'Customer Credit Total' }, type: FieldType.PRICE, blockId: 'financial_stats', readonly: true },
    { key: 'total_balance', labels: { fa: 'مانده عملیاتی مشتری', en: 'Customer Operational Balance' }, type: FieldType.PRICE, blockId: 'financial_stats', readonly: true },
    ...
    { key: 'loyalty_credit_balance', labels: { fa: 'اعتبار باشگاه مشتریان', en: 'Customer Club Credit' }, type: FieldType.PRICE, blockId: 'financial_stats', readonly: true, isTableColumn: false },
