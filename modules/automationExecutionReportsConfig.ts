...
export const automationExecutionReportsConfig: ModuleDefinition = {
  ...
  fields: [
    ...
    { key: 'record_title', labels: { fa: 'رکورد مرتبط', en: 'Related Record' }, type: FieldType.TEXT, location: FieldLocation.BLOCK, blockId: 'details', order: 1, nature: FieldNature.SYSTEM },
