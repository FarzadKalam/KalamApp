...
const fieldsArray: any[] = [
  ...
  { key: 'status', labels: { fa: 'وضعیت', en: 'Status' }, type: FieldType.STATUS, location: FieldLocation.HEADER, order: 4, options: [{ label: 'فعال', value: 'active', color: 'green' }, { label: 'غیرفعال', value: 'draft', color: 'orange' }], isTableColumn: true },
  ...
  { key: 'category', labels: { fa: 'دسته بندی کالا', en: 'Goods Category' }, type: FieldType.SELECT, location: FieldLocation.BLOCK, blockId: 'baseInfo', order: 1, dynamicOptionsCategory: 'product_goods_categories', nature: FieldNature.STANDARD, validation: { required: false }, logic: { visibleIf: { field: 'product_type', operator: LogicOperator.EQUALS, value: 'goods' } }, isTableColumn: true },
  { key: 'product_category', labels: { fa: 'دسته بندی خدمات', en: 'Service Category' }, type: FieldType.SELECT, location: FieldLocation.BLOCK, blockId: 'baseInfo', order: 2, dynamicOptionsCategory: 'product_service_categories', nature: FieldNature.STANDARD, validation: { required: false }, logic: { visibleIf: { field: 'product_type', operator: LogicOperator.EQUALS, value: 'service' } }, isTableColumn: true },
  ...
  { key: 'accounting_code', labels: { fa: 'کد مالیاتی', en: 'Accounting Code' }, type: FieldType.NUMBER, location: FieldLocation.BLOCK, order: 7.5, nature: FieldNature.STANDARD, isTableColumn: false },
