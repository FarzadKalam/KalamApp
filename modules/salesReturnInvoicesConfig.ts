...
export const salesReturnInvoicesConfig: ModuleDefinition = {
  id: 'sales_return_invoices',
  titles: { fa: 'فاکتورهای برگشت از فروش', faSingular: 'فاکتور برگشت از فروش', en: 'Sales Return Invoices' },
  ...
  fields: [
    ...
    { key: 'system_code', labels: { fa: 'کد سیستمی', en: 'Code' }, type: FieldType.TEXT, location: FieldLocation.HEADER, order: 3, readonly: true, nature: FieldNature.SYSTEM, isTableColumn: false },
    {
      ...
      options: [
        ...
        { label: 'نهایی', value: 'final', color: 'green' },
    ...
    },
    {
      ...
      labels: { fa: 'فاکتور فروش اصلی', en: 'Original Invoice' },
      type: FieldType.RELATION,
      location: FieldLocation.HEADER,
      order: 5.5,
      relationConfig: {
  ...
  relatedTabs: [
    {
      id: 'return_invoice_journal_entries',
