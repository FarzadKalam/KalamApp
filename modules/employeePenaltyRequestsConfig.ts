...
export const employeePenaltyRequestsModule: ModuleDefinition = {
  id: 'employee_penalty_requests',
  titles: { fa: 'جریمه‌ها', faSingular: 'درخواست جریمه', en: 'Employee Penalty Requests' },
  ...
  fields: [
    ...
    { key: 'amount', labels: { fa: 'مبلغ جریمه', en: 'Penalty Amount' }, type: FieldType.PRICE, location: FieldLocation.HEADER, order: 5, validation: { required: true }, nature: FieldNature.STANDARD, isTableColumn: true },
    {
      key: 'status',
    ...
    { key: 'reason', labels: { fa: 'شرح جریمه', en: 'Reason' }, type: FieldType.LONG_TEXT, blockId: 'details', order: 3, nature: FieldNature.STANDARD },
  ...
  blocks: [
    { id: 'details', titles: { fa: 'جزئیات جریمه', en: 'Details' }, type: BlockType.FIELD_GROUP, order: 1 },
  ],
  relatedTabs: [],
};
