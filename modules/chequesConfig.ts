...
export const chequesConfig: ModuleDefinition = {
  ...
  fields: [
    ...
    {
      key: 'issue_date',
      labels: { fa: 'تاریخ صدور', en: 'Issue Date' },
      type: FieldType.DATE,
      location: FieldLocation.HEADER,
      order: 5,
      isTableColumn: true,
    ...
    {
      key: 'amount',
      labels: { fa: 'مبلغ (ریال)', en: 'Amount (Rial)' },
    ...
    {
      key: 'bank_account_id',
      labels: { fa: 'حساب بانکی متناظر', en: 'Bank Account' },
      type: FieldType.RELATION,
      location: FieldLocation.BLOCK,
      blockId: 'issuance',
      order: 9,
      nature: FieldNature.STANDARD,
      relationConfig: { targetModule: 'bank_accounts', targetField: 'account_number' },
    },
    {
      key: 'notes',
