...
const SaasAdminCatalogItems: React.FC = () => {
  ...
  const edit = (item?: any) => {
    ...
    form.resetFields();
    form.setFieldsValue(item || { item_kind: 'quota', quantity: 1, price_irt: 0, is_active: false, is_public: true, sort_order: 100 });
    setOpen(true);
  };
  const save = async () => {
    try {
