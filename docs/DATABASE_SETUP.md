...
> وضعیت: این راهنما شامل مثال‌های legacy نیز هست.  
> مرجع رسمی مسیر v1: `BLUEPRINT_V1.md`  
> برای پروژه عمومی، مقادیر domain-specific (مثل دسته‌های خاص یک صنعت) باید با گزینه‌های عمومی یا گزینه‌های هر tenant جایگزین شوند.
