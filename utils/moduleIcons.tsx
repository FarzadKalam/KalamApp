...
export const MODULE_ICON_KEYS: Record<string, string> = {
  ...
  content_calendars: 'calendar', reservations: 'calendar', reservation_resources: 'appstore', production_boms: 'calculator', production_orders: 'container', production_group_orders: 'container',
